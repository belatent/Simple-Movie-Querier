...
namespace A2Q3
{
    public partial class WatchList : Form
    {
        ...
        private void readMov()
        {
            ...
            label1.Text = numOfMovies + " movie(s) in your watch list. Click for detail.";
        }

        private void button3_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Are you sure to remove the movie :《" + listView1.SelectedItems[0].SubItems[0].Text + "》 from your watch list?", "Warring", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {
